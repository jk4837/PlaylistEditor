...
void PlaylistEditor::CreateSongActionButton() {
    ...
    this->removeButton = new IconButton("RemoveFromListButton", deleteButtonTransform->get_parent()->get_parent(), "PracticeButton",
                                            UnityEngine::Vector2(posX, posY - 15.0f), UnityEngine::Vector2(10.0f,7.0f), [this]() {
            if (this->UpdateFileWithSelected(FILE_ACTION::ITEM_REMOVE)) {
    ...
    this->insertButton = new IconButton("InsertFromListButton", deleteButtonTransform->get_parent()->get_parent(), "PracticeButton",
                                            UnityEngine::Vector2(posX, posY - 15.0f), UnityEngine::Vector2(10.0f,7.0f), [this, posX, posY]() {
            ...
            if (!this->listModal) {
                ...
                this->listModal = new ListModal(screenContainer->get_transform(), UnityEngine::Vector2(30.0f, 25.0f), UnityEngine::Vector2(posX + 57.0f, posY - 25.0f),
...
{
    GlobalNamespace::SharedCoroutineStarter::get_instance()->StartCoroutine(reinterpret_cast<System::Collections::IEnumerator*>(custom_types::Helpers::CoroutineHelper::New(this->doAdjustUI(forceDisable))));
}
